...
sys.path.append("../../")
sys.path.insert(1, '/home/asiimov/workspace/HRL_RobotGym')
...
def train_mujoco_ppo(env_name, model_idx, ppo_epochs=25, seed=0, batch_size=64,
    ...
    config = load_config("/home/asiimov/workspace/HRL_RobotGym")
...
if __name__ == '__main__':
    ...
    for num in range(0, NUM_MODEL):
        ...
        train_mujoco_ppo(env_name, num, ppo_epochs=25, seed=random_seed, use_cuda=False,
                         tb_comment=COMMENT, spike_ts=5, num_envs=1, std=math.sqrt(0.15),
